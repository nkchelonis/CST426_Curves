...
public static class QuadraticBezierMath
{
    ...
    {
        // Slice 2.2: return the derivative at t from your De Casteljau construction.
        // Do not normalize it.
    ...
    {
        // Slice 7.1: compute C0, C1, C2 from the equations above.
    ...
    {
        // Slice 7.2: evaluate P(t) from the coefficients.
    ...
    {
        // Slice 7.4: evaluate P'(t) from the coefficients. Do not normalize it.
